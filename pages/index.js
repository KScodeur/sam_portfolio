  ...
  return(
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg img */}
        <div className=" bg-none xl:bg-explosion xl:bg-over xl:bg-right xl:bg-no-repeat w-full h-full
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-16
